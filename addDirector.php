                            ...
                            <div class="user-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <select name="role">
                                        ...
                                        <option value="role1">Assistant Director</option>
                                        <option value="role2">Finance Director</option>
                                        <option value="role3">Executive Director</option>
                                        <option value="role4">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" name="town_vilage" placeholder="Enter your town/village"
                                        required />
                                </div>
                                <div class="input-box">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" name="whatsapp_number" placeholder="Enter your Whatsapp number"
                                        required />
                                </div>
                                <div class="input-box">
                                    <span class="details"></span>
                                    <select name="province">
                                        ...
                                        <option value="Matola">Matola (Mozambique)</option>
                                ...
                                <div class="input-box">
                                    <span class="details"></span>
                                    <textarea name="address" cols="39" rows="7" style="height: 100px"
                                        placeholder="Enter your physical/ postal address"></textarea>
                                </div>
                            </div>
                            <div class="button">
