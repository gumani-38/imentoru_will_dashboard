...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            color: #00aee0;
            margin-left: 24px;
          ">Add New Coordinator</span>
            <div class="align-center">
                <div class="form-container">
                    <div class="content">
                        <form action="./php/addCoordinator.php" method="post">
                            <div class="user-details">
                                ...
                                <div class="input-box">
                                    ...
                                    <textarea name="address" id="" cols="39" rows="7" style="height: 100px"
                                        placeholder="Enter your physical/ postal address" required></textarea>
                                </div>
                            </div>
