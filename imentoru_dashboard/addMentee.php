...
$sql = "INSERT INTO mentees (first_name, last_name, email, phone_number, occupation, town_vilage, id_number, whatsapp_number, school_attending, province, gender, country, address)
...
if ($conn->query($sql) === TRUE) {
    echo "New mentee added successfully";
} else {
